...
- Copy the tests from `scaffold/4.1-psbt-review/lesson_4_1_psbt_review.rs` into `tests/lesson_4_1_psbt_review.rs`.
...
Defined in `scaffold/4.1-psbt-review/lesson_4_1_psbt_review.rs`:
