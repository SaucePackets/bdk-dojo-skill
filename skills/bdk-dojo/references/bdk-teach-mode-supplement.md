...
- dump the full function body in a hint. Give the shape, not the implementation. If you catch yourself writing a complete match block or function body, stop and trim it to a concept description.
